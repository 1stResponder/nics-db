...
psql -d nics -U postgres -w -c "INSERT INTO nicssystem VALUES (%~3, '%~1', '%~2', true)"
psql -d nics -U postgres -w -c "INSERT INTO workspace VALUES (%~5, '%~4', true)"
psql -d nics -U postgres -w -c "INSERT INTO system_workspace VALUES ((select nextval('hibernate_sequence')), %~3, %~5)"
exit /B 0
