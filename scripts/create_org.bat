...
REM create the org
psql -d nics -U postgres -w -c "INSERT INTO org VALUES ((select nextval('org_seq')), '%~1', '%~2', '%~3', NULL, '%~4', NULL, 38.8950000000000031, -77.0366700000000009, NULL, 'USA', now())"
psql -d nics -U postgres -w -c "INSERT INTO org_orgtype VALUES ((select nextval('hibernate_sequence')), (select last_value from org_seq), %~5)"
exit /B 0
